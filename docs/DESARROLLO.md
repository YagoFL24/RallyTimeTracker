...
El repositorio contiene 107 pruebas unitarias y funcionales. Las operaciones de datos se ejecutan sobre bases SQLite temporales, nunca sobre `data/datos.db`.

Cobertura automatizada actual:

- parsing y formato de tiempos;
- entrada compacta de tiempos, autocompletado de milisegundos y normalización visual;
